<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-semibold">Create Service</h2>
            <p class="text-sm text-gray-500">
                Add new service and assign works
            </p>
        </div>
    ...
    <div class="bg-white rounded-xl border p-6 max-w-3xl">
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div>
                ...
                <select wire:model.defer="service_category_id"
                        class="w-full rounded-lg border px-4 py-2">
            ...
            <div>
                ...
                <input type="text" wire:model.defer="hero_video"
        ...
        @endforeach
            ...
            <div class="flex items-center gap-3 pt-4">
                <button type="submit"
                        class="bg-[#f38121] text-white px-6 py-2 rounded-lg">
                    Save Service
                </button>
